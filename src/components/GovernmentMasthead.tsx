...
export const GovernmentMasthead: React.FC<GovernmentMastheadProps> = ({
  ...
  return (
    <div id="goi-masthead" class="w-full bg-[#0B1E36] text-slate-200 text-xs border-b border-slate-700/60 select-none">
      {/* Indian National Tricolor Top Stripe (Saffron, White, Green) */}
      <div class="india-tricolor-bar"></div>

      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-1.5 flex flex-wrap items-center justify-between gap-3">
        ...
        <div class="flex items-center gap-3">
          ...
          <div class="flex items-center gap-2.5">
            <svg
              viewBox="0 0 100 100"
              class="w-6 h-6 text-amber-400 drop-shadow-sm shrink-0 fill-current"
            ...
            <div class="leading-tight">
              <div class="flex items-center gap-2">
                <span class="font-bold tracking-wide text-white font-['Noto_Sans_Devanagari',sans-serif]">भारत सरकार</span>
                <span class="text-slate-400">|</span>
                <span class="font-semibold tracking-wide text-slate-200">Government of India</span>
              </div>
              <p class="text-[10px] text-slate-300 truncate max-w-[280px] sm:max-w-none">
                {language === 'हिन्दी'
        ...
        <div class="flex items-center gap-3 text-[11px]">
          {/* Mission Tag */}
          <span class="hidden md:inline-block text-[10px] text-slate-300 font-medium tracking-wide">
            राष्ट्रीय सिविल सेवा क्षमता विकास कार्यक्रम (NPCSCB)
          </span>

          <div class="h-3 w-px bg-slate-700 hidden md:block"></div>

          {/* Secure .gov.in Badge */}
          <div class="flex items-center gap-1 text-[10px] text-emerald-400 bg-emerald-950/70 border border-emerald-800/80 px-2 py-0.5 rounded font-mono font-semibold">
          ...
          <button
            ...
            class="flex items-center gap-1.5 px-2.5 py-1 rounded bg-slate-800 hover:bg-slate-700 text-slate-200 hover:text-white border border-slate-700 transition-colors cursor-pointer text-[11px] font-semibold"
